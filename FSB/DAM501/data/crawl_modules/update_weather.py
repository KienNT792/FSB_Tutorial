"""
Script để cập nhật dữ liệu thời tiết Hà Nội từ Weatherbit API
Lấy dữ liệu từ 2025-10-30:16 đến hiện tại
"""
...
LAT = 21.0285  # Hà Nội
LON = 105.8542
DATA_FILE = "../data_file/hanoi_weather_history.csv"

# Bắt đầu từ ngày 2025-10-30 00:00
start_date = datetime(2025, 10, 30, 0)
...
def get_weather_data(start, end):
    """
    Lấy dữ liệu weather history từ Weatherbit API
    """
...
while current_start < end_date:
    ...
    # Lấy dữ liệu
    records = get_weather_data(current_start, current_end)
